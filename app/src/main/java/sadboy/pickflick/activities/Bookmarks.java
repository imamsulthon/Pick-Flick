...
import sadboy.pickflick.fragments.MovieBookmarks;
import sadboy.pickflick.fragments.TVBookmarks;
import sadboy.pickflick.http.ConnectivityReceiver;
import sadboy.pickflick.http.MyApplication;

public class Bookmarks extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MovieBookmarks movieBookmarks = new MovieBookmarks();
        appAdapter.addFragment(movieBookmarks, "Movies");
        TVBookmarks tvBookmarks = new TVBookmarks();
        appAdapter.addFragment(tvBookmarks, "TV Shows");
        ...
        snackbar = Snackbar
                .make(findViewById(R.id.bookmarks_activity), "No Internet Connection", Snackbar.LENGTH_INDEFINITE)
    ...
    private void setDrawer(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_bookmarks);
        setSupportActionBar(toolbar);

        result = new DrawerBuilder(this)
                .withRootView(R.id.drawer_container_bookmarks)
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        switch (position) {
                            case 0: {
                                ...
                                Intent i = new Intent(Bookmarks.this, Films.class);
                            ...
                            break;
                            case 1: {
                                Intent i = new Intent(Bookmarks.this, TV.class);
                                i.putExtra("popularMovieJsonData", popularMoviesJsonData);
                                i.putExtra("popularTVJsonData", popularTVJsonData);
                                startActivity(i);
                            }
                            break;
                            case 2: {
                                Intent i = new Intent(Bookmarks.this, Celebrities.class);
                                i.putExtra("popularMovieJsonData", popularMoviesJsonData);
                                i.putExtra("popularTVJsonData", popularTVJsonData);
                                startActivity(i);
                            ...
                            break;
                            case 5: {
                                Intent i = new Intent(Bookmarks.this, Reminders.class);
                                i.putExtra("popularMovieJsonData", popularMoviesJsonData);
                                i.putExtra("popularTVJsonData", popularTVJsonData);
                                startActivity(i);
                            }
                            ...
                            break;
                            default: {
                                Toast.makeText(Bookmarks.this, ("Invalid Choice " + position), Toast.LENGTH_SHORT).show();
                            }
                        }
                        return false;
                    }
                })
                .withSavedInstance(savedInstanceState).withSelectedItemByPosition(4)
                .build();
    ...
    protected void onResume() {
        super.onResume();
        MyApplication.getInstance().setConnectivityListener(Bookmarks.this);
    }
