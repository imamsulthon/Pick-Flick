...
import sadboy.pickflick.adapters.MoreTVAdapter;
...
public class MoreTV extends AppCompatActivity implements JsonDataSetter, ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        p = (ProgressBar) findViewById(R.id.more_tv_progress_bar);
        ...
        TextView mm = (TextView)findViewById(R.id.more_tv_type);
        switch (type)
        {
            case "1": mm.setText("Top Rated");
                break;
            case "2": mm.setText("Air Today");
                break;
            case "3": mm.setText("On Air");
                break;
        ...
        recyclerView = (RecyclerView) findViewById(R.id.more_tv_recyclerview);
        adapter = new MoreTVAdapter(this, tvs, p);
        recyclerView.setAdapter(adapter);
        layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);

        snackbar = Snackbar
                .make(findViewById(R.id.activity_more_tv), "No Internet Connection", Snackbar.LENGTH_INDEFINITE)
    ...
    public void setUrls(int page) {
        ...
        switch (type)
        {
            case "1": movieUrl = url.getTopRatedTV(p);
                break;
            case "2": movieUrl = url.getAiringTodayTV(p);
                break;
            case "3": movieUrl = url.getOnTheAirTV(p);
                break;
    ...
    public void setPopularPeople(String jsonData) {
        ...
        try {
            ...
            for (int i = 0; i < dataSize; i++) {
                ...
                tv.setOverview(jsonFilm.getString("overview"));
    ...
    private void setDrawer(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_more_tv);
        setSupportActionBar(toolbar);

        result = new DrawerBuilder(this)
                .withRootView(R.id.drawer_container_more_tv)
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        switch (position) {
                            case 0: {
                                ...
                                Intent i = new Intent(MoreTV.this, Films.class);
                            ...
                            break;
                            case 1: {
                                Intent i = new Intent(MoreTV.this, TV.class);
                                i.putExtra("popularMovieJsonData", popularMoviesJsonData);
                                i.putExtra("popularTVJsonData", popularTVJsonData);
                                startActivity(i);
                            }
                            break;
                            case 2: {
                                Intent i = new Intent(MoreTV.this, Celebrities.class);
                                i.putExtra("popularMovieJsonData", popularMoviesJsonData);
                                i.putExtra("popularTVJsonData", popularTVJsonData);
                                startActivity(i);
                            }
                            break;
                            case 4: {
                                Intent i = new Intent(MoreTV.this, Bookmarks.class);
                                startActivity(i);
                            }
                            break;
                            case 5: {
                                Intent i = new Intent(MoreTV.this, Reminders.class);
                                i.putExtra("popularMovieJsonData", popularMoviesJsonData);
                                i.putExtra("popularTVJsonData", popularTVJsonData);
                                startActivity(i);
                            }
                            ...
                            break;
                            default: {
                                Toast.makeText(MoreTV.this, ("Invalid Choice " + position), Toast.LENGTH_SHORT).show();
                            }
                        }
                        return false;
                    }
    ...
    protected void onResume() {
        super.onResume();
        MyApplication.getInstance().setConnectivityListener(MoreTV.this);
        ProgressBar p = (ProgressBar) findViewById(R.id.more_tv_progress_bar);
        p.setVisibility(View.INVISIBLE);
    }
