 ...
 */
public class ReminderAdapter extends RecyclerView.Adapter<ReminderAdapter.ViewHolder> implements AsyncDownloader.JsonDataSetter {
    ...
    public ReminderAdapter(Context ctx, List<SearchResult> results, ProgressBar progressBar) {
        this.context = ctx;
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            date = (TextView) itemView.findViewById(R.id.media_type);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.date.setText(result.getMediaDate());
                        ...
                        .setPositiveButton("DELETE",
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        if (type.equals("TV")) {
                                            SharedPreferences write = context.getApplicationContext().getSharedPreferences("Reminders_TV", 0);
                                            ...
                                            for (int i = 0; i < results.size(); i++) {
                                                ...
                                                s4 = s4 + "," + results.get(i).getMediaDate();
                                            }

                                            editor.putString("TVID", s1);
                                            editor.putString("TVTitle", s2);
                                            editor.putString("TVImage", s3);
                                            editor.putString("TVDate", s4);

                                            editor.apply();
                                        } else if (type.equals("Movie")) {
                                            SharedPreferences write = context.getApplicationContext().getSharedPreferences("Reminders_Movie", 0);
                                            SharedPreferences.Editor editor = write.edit();
                                            editor.clear();
                                            editor.apply();
